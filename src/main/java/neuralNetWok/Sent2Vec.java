...
public class Sent2Vec {
  ...
  public void initialCharVec() throws Exception {
    File inFile = new File("/home/casey/projects/up/qa-bot-dl4j-nn/src/main/resources/singleCharVec.txt");
  ...
  public LinkedList<String> getAswList() throws Exception {
    ...
    File inFile = new File("/home/casey/projects/up/qa-bot-dl4j-nn/src/main/resources/answer.txt");
    FileReader fReader = new FileReader(inFile);
    BufferedReader bfr = new BufferedReader(fReader);
    String str;
    while ((str = bfr.readLine()) != null) {
