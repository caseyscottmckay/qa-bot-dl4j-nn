...
public class Output_Sent2Vec {
  public static void main(String[] args) throws Exception {
    //请提前设置好 训练-问序.txt 文件
    outputCharVec();
    File charFile = new File("/home/casey/projects/up/campusQA/src/main/resources/singleCharVec.txt");
    File inFileTe = new File("/home/casey/projects/up/campusQA/src/main/resources/测试-问序.txt");
    File outFileTe = new File("/home/casey/projects/up/campusQA/src/main/resources/w2v_test.txt");
    File inFileTr = new File("/home/casey/projects/up/campusQA/src/main/resources/训练-问序.txt");
    File outFileTr = new File("/home/casey/projects/up/campusQA/src/main/resources/w2v_tr.txt");
    File inFileVa = new File("/home/casey/projects/up/campusQA/src/main/resources/验证-问序.txt");
    File outFileVa = new File("/home/casey/projects/up/campusQA/src/main/resources/w2v_val.txt");
  ...
  private static void outputCharVec() throws Exception {
    ...
    File file = new File("/home/casey/projects/up/campusQA/src/main/resources/训练-问序.txt");
    File charFile = new File("/home/casey/projects/up/campusQA/src/main/resources/singleCharVec.txt");
